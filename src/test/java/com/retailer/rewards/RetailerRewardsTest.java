...
public class RetailerRewardsTest {
	...
	public void getRewardPointsForCutomer1() throws ParseException {
		customer1();
		CustomerRewardsDTO  customerDetails = rewardsService.getCustomerRewardPoints("c1");
	...
	public void getRewardPointsForCutomer2() throws ParseException{
		customer2();
		CustomerRewardsDTO  customerDetails = rewardsService.getCustomerRewardPoints("c2");
